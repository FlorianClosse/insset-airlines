...
public class OutputSeb extends AsyncTask<String, Integer, String> {
	...
	protected String doInBackground(String... arg0) {
		...
		try {
			...
			HttpPost hpost = new HttpPost(new URI(urlPhp));
		...
		if (!IoSeb.erreur.equals("connection")) {
			try {
				...
				// Log.e("log_tag", "Erreur de convertion du resultat" +
				// e.toString());
				IoSeb.erreur = "convertion";
			}
		}
		if (!IoSeb.erreur.equals("convertion")
				&& !IoSeb.erreur.equals("connection")) {
			try {
				...
				// Log.e("log_tag", "Erreur recuperation donnees" +
				// e.toString());
				// res = new String[0][0];
