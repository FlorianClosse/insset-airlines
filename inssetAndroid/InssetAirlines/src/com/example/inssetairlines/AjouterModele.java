    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        validerModele.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				modele.setLongueurPiste(Integer.valueOf(longueurPiste.getText().toString()));
				modele.setRayonDaction(Integer.valueOf(rayonAction.getText().toString()));
				modele.setNbPlace(Integer.valueOf(nbPlace.getText().toString()));
				modele.setPeriodePetiteRevision(Integer.valueOf(petiteRev.getText().toString()));
				modele.setPeriodeGrandeRevision(Integer.valueOf(grandeRev.getText().toString()));
