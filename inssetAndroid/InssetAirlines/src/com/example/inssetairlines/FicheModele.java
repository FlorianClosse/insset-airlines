...
public class FicheModele extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Modele.lireLigneModeleAvecId(idModele, getApplicationContext(), handlerLireLigneModeleAvecId);
    ...
    Handler handlerLireLigneModeleAvecId = new Handler() {
    	public void handleMessage(Message msg) {    		
    		...
    		petiteRev.setText(String.valueOf(modele.getPeriodePetiteRevision()));
    		grandeRev.setText(String.valueOf(modele.getPeriodeGrandeRevision()));
    	}
    };
