...
public class Calendrier extends Activity {
	...
	private OnClickListener listenerValider = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			datePrevue = String.valueOf(annee) + "-" + String.valueOf(mois)
					+ "-" + String.valueOf(jour);
			...
			ioSeb.inputSeb(UrlScriptsPhp.urlValiderDateRevisionPrevue,
					handlerValiderDate, getApplicationContext());
		}
	};

	private Handler handlerValiderDate = new Handler() {
		public void handleMessage(Message msg) {
			ToastSeb.toastSeb(getApplicationContext(), "Révision prévue le "
					+ datePrevue + " pour " + immatriculationAvion);
			finish();
		}
	};
