...
--
-- Client: localhost
-- Généré le : Mar 29 Janvier 2013 à 14:31
...
--
-- Contenu de la table `commentaireVol`
--

INSERT INTO `commentaireVol` (`idCommentaireVol`, `idJournalDeBord`, `titre`, `commentaire`, `idVol`) VALUES
(5, 1, 'vsdbs', 'vesb', NULL),
(6, 1, 'ezvze', 'vzqvz', NULL),
(7, 3, 'New commentaire', 'New com test', NULL),
(8, 3, 'az', 'ze', NULL),
(9, 3, 'Blabla', 'ble', NULL);
...
CREATE TABLE IF NOT EXISTS `journalDeBord` (
  ...
  KEY `j3` (`idAvion`),
  KEY `j4` (`idVol`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=55255 ;
...
(1, 1, 2, 1, 2, '2013-01-28', 130, 'attente'),
(2, 3, 4, 2, 8, '2013-01-29', 19, 'attente'),
(3, 3, 4, 1, 10, '2013-01-30', 4444, 'en vol'),
(4, 1, 5, 2, 9, '0000-00-00', 33, 'en vol'),
(5, 2, 3, 1, 12, '0000-00-00', 55, 'en vol'),
(6, 1, 2, 2, 13, '0000-00-00', 77, 'attente'),
(7, 3, 4, 2, 14, '0000-00-00', 55, 'attente'),
(55252, 1, 4, 2, 10, '2013-01-27', 555, 'ok'),
(55253, 1, 1, NULL, 11, '2013-02-26', NULL, 'attente'),
(55254, 1, 1, NULL, 14, '2013-02-26', NULL, 'attente');
...
INSERT INTO `pilote` (`idPilote`, `nomPilote`, `prenomPilote`, `adresse`, `telephone`, `email`, `idAeroportEmbauche`) VALUES
(1, 'dupon', 'jean', '15 rue machin', '0635854312', 'jeandupon@gmail.com', 1),
(2, 'derache', 'matthieu', '6 rue pasteur', '0644444444', 'mathDerache@gmail.com', 2),
(3, 'beze', 'nicolas', '6 rue pasteur', '0623370599', 'nicolas.beze@laposte.net', 3),
(4, 'closse', 'florian', '1 rue truck', '0633333333', 'flo.closse@gmail.com', 1),
(5, 'doyen', 'cyril', '2 rue blabla', '0688888888', 'cyrilD@hotmail.fr', 2),
(6, 'zzzzz', 'zzzzz', 'zzzzzzz', '1111111111', 'nnnnn@laposte.net', 1),
(7, 'zzzzz', 'zzzzz', 'zzzzzzz', '1111111111', 'nnnnn@laposte.net', 1),
(8, 'zzz', 'zzz', 'zzz', 'zzz', 'zzzz', 2),
(9, 'poiuytre', 'poiuytr', 'oijuhg', '02515', 'l,jkiv', 1),
(10, 'gg', 'hgh', 'hhhg', '0224502404', 'hghh@km.com', 1),
(11, 'vsqvs', 'bsbs', 'sbsbs', '1148', 'sbs@esbv.com', 1),
(12, 'kkk', 'hjjj', 'jjkjj', '2555', 'hhj@turlututu.fr', 2),
(13, 'nnn', 'nnn', 'nnn', '123', 'nnn@nnn.fr', 1);
...
CREATE TABLE IF NOT EXISTS `reservation` (
  ...
  `nbPlaceReservee` int(11) NOT NULL,
  `heureReservation` bigint(20) NOT NULL,
...
INSERT INTO `reservation` (`idReservation`, `statutReservation`, `nbPlaceReservee`, `heureReservation`, `idJournal`) VALUES
(17, 'en attente', 1, 1359372927, 1),
(19, 'en attente', 1, 1359379416, 2),
(20, 'en attente', 15, 1359383003, 1),
(21, 'en attente', 2, 1359390340, 1),
(22, 'en attente', 10, 1359390373, 1);
...
INSERT INTO `user` (`idUser`, `nomUser`, `prenomUser`, `email`, `motDePasse`, `dateNaissance`, `service`, `idAeroport`) VALUES
(1, 'a', 'a', 'admin@admin.fr', 'admin', '2013-01-02', 1, 1);
...
INSERT INTO `vol` (`idVol`, `numVol`, `aeroportDepart`, `aeroportArrivee`, `datePrevu`, `dureeVol`) VALUES
(2, 'blablabla', 1, 3, '2012-10-21', 75),
(8, 'blablabla', 2, 3, NULL, 500),
(9, 'num342657', 2, 1, NULL, 456),
(10, 'aaaaaaaaaaaaa', 1, 1, NULL, 405),
(11, 'aaaaaaaaaazzzzzzzzzzzzzzzzzz', 1, 3, NULL, 345),
(12, '', 1, 1, '2012-10-10', 0),
(13, '', 1, 1, '2012-10-10', 0),
(14, 'aaaaaaa', 1, 1, NULL, 240),
(15, '111111111111111111111', 1, 1, NULL, 345),
(16, '9', 1, 1, NULL, 0),
(17, '123', 1, 2, NULL, 207360),
(18, '123', 1, 2, NULL, 1003),
(19, '89855', 1, 1, '2012-12-12', 4140),
(20, '9999', 1, 1, NULL, 240);
...
ALTER TABLE `commentaireVol`
  ...
  ADD CONSTRAINT `commentaireVol_ibfk_2` FOREIGN KEY (`idVol`) REFERENCES `vol` (`idVol`);
